...
public class PluginConfig {
	...
	public static class DefaultConfig {
		...
		// Whether to gzip files
		public static final boolean gzip = false;
	...
	/**
	 * Reads from the config file into memory. If the config file doesn't exist or is deleted, uses the default values.
	 */
	public static void readConfig() {
		...
		final String cacheDefault = DefaultConfig.cache.toString();
		...
		gzip = ConfigHelper.getBoolean("press.gzip", DefaultConfig.gzip);
		compressionKeyStorageTime = ConfigHelper.getString("press.key.lifetime", DefaultConfig.compressionKeyStorageTime);
		maxCompressionTimeMillis = ConfigHelper.getInt("press.compression.maxTimeMillis", DefaultConfig.maxCompressionTimeMillis);
		htmlCompatible = ConfigHelper.getBoolean("press.htmlCompatible", DefaultConfig.htmlCompatible);
		...
		css.compressedDir = ConfigHelper.getString("press.css.outputDir", DefaultConfig.css.compressedDir);

		js.srcDir = ConfigHelper.getString("press.js.sourceDir", DefaultConfig.js.srcDir);
		js.compressedDir = ConfigHelper.getString("press.js.outputDir", DefaultConfig.js.compressedDir);
		...
		js.preserveAllSemiColons = ConfigHelper.getBoolean("press.yui.js.preserveAllSemiColons", DefaultConfig.js.preserveAllSemiColons);
		js.preserveStringLiterals = ConfigHelper.getBoolean("press.yui.js.preserveStringLiterals", DefaultConfig.js.preserveStringLiterals);
