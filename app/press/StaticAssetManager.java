...
/**
 * Copied and modified from https://github.com/lunatech-labs/play-module-less/blob /master/src/play/modules/less/Plugin.java
 */
public class StaticAssetManager {
	...
	private void handleResponse(VirtualFile file, Request request, Response response) throws IOException {
		final long lastModified = StyleCompressor.lessEngine.latestModified(file.getRealFile());
		...
		// rendered.
		final boolean reprocessFile = Play.mode.equals(Play.Mode.DEV) && startTime > lastModified;
